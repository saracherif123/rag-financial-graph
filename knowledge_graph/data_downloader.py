...
This module downloads real financial data from Yahoo Finance and prepares it
for the knowledge graph. It includes stock prices, company information,
...
class FinancialDataDownloader:
    """Downloads and processes financial data from Yahoo Finance."""
    
    def __init__(self):
        """Initialize the downloader with S&P 500 companies."""
    ...
    def download_stock_data(self, period: str = "2y") -> pd.DataFrame:
        """
        Download historical stock data for the companies.
    ...
    def get_financial_statements(self) -> Dict[str, List[Dict[str, Any]]]:
        """
        Get financial statements for companies.
    ...
    def save_data(self, output_dir: str = "data/financial"):
        """
        Download all data and save to files. If any part fails, use existing data for that part.
        Args:
